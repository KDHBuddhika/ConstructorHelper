...
//
    ...
    List<Companies> findByConstructiontypeEquals(String contype);

    List<Companies> findByDistrctEquals(String destrict);


    Companies findByCompanyEmailEqualsAndCompanyPasswordEquals(String companyEmail, String password);
}
